...
public class Mascota implements Serializable {
    ...
    public Mascota(int num_cliente, String nombre_masco, String raza, String color, String alergico, String atencion_especial, String observaciones, Duenio unDuenio) {
